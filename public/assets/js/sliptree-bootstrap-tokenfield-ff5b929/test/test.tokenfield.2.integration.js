describe('2. Integration tests:', function() {
  ...
  before(function() {
    require('jquery-simulate-ext/libs/bililiteRange');
    require('jquery-simulate-ext/libs/jquery.simulate');
    ...
    require('jquery-simulate-ext/src/jquery.simulate.ext');
    require('jquery-simulate-ext/src/jquery.simulate.key-combo');
    require('jquery-simulate-ext/src/jquery.simulate.key-sequence');
  });
